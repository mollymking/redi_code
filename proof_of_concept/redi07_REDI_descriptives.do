...
capture log close redi07_REDI_descriptives
log using $redi/redi07_REDI_descriptives.log, name(redi07_REDI_descriptives) replace text
...
foreach y of local years { // loop through all years
	...
	keep if redi_hinc_cont_inf2017 != .
